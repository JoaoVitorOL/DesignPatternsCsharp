...
- Parte 1 — Fundamentos e Base de Linguagem
  - [1. O que é SOLID e por que ele existe](#1-o-que-é-solid-e-por-que-ele-existe)
    - [1.1 O tipo de problema que SOLID combate](#11-o-tipo-de-problema-que-solid-combate)
    - [1.2 SOLID não é uma religião](#12-solid-não-é-uma-religião)
  - [2. Conceitos de C# que ajudam a ler os exemplos](#2-conceitos-de-c-que-ajudam-a-ler-os-exemplos)
    ...
    - [2.3 Herança](#23-herança)
    - [2.4 `virtual`, `override` e `new`](#24-virtual-override-e-new)
    - [2.5 `IEnumerable<T>`](#25-ienumerablet)
    - [2.6 `yield return`](#26-yield-return)
    - [2.7 Tuplas e `Item1`, `Item2`, `Item3`](#27-tuplas-e-item1-item2-item3)
    - [2.8 Valores padrão em parâmetros](#28-valores-padrão-em-parâmetros)
    - [2.9 `readonly`](#29-readonly)
- Parte 2 — Os Cinco Princípios
  - [3. Single Responsibility Principle (SRP)](#3-single-responsibility-principle-srp)
    ...
    - [3.2 O que é uma "razão para mudar"](#32-o-que-é-uma-razão-para-mudar)
    - [3.3 Leitura guiada do exemplo errado](#33-leitura-guiada-do-exemplo-errado)
    - [3.4 Por que isso é uma violação de SRP](#34-por-que-isso-é-uma-violação-de-srp)
    - [3.5 Pontos de C# que o leitor talvez não conheça](#35-pontos-de-c-que-o-leitor-talvez-não-conheça)
    - [3.6 Como o exemplo certo melhora o design](#36-como-o-exemplo-certo-melhora-o-design)
    - [3.7 O que melhorou de verdade](#37-o-que-melhorou-de-verdade)
    - [3.8 Consequências práticas de SRP](#38-consequências-práticas-de-srp)
    - [3.9 Checklist mental para SRP](#39-checklist-mental-para-srp)
  - [4. Open-Closed Principle (OCP)](#4-open-closed-principle-ocp)
    - [4.1 Definição](#41-definição)
    - [4.2 O problema que OCP tenta evitar](#42-o-problema-que-ocp-tenta-evitar)
    - [4.3 Leitura guiada do exemplo errado](#43-leitura-guiada-do-exemplo-errado)
    - [4.4 Por que o design escala mal](#44-por-que-o-design-escala-mal)
    - [4.5 Pontos de C# que aparecem no exemplo](#45-pontos-de-c-que-aparecem-no-exemplo)
    - [4.6 Leitura guiada do exemplo correto](#46-leitura-guiada-do-exemplo-correto)
    - [4.7 O que aconteceu conceitualmente](#47-o-que-aconteceu-conceitualmente)
    - [4.8 O que é `ISpecification<T>`](#48-o-que-é-ispecificationt)
    - [4.9 O que `yield return` ajuda a mostrar aqui](#49-o-que-yield-return-ajuda-a-mostrar-aqui)
    - [4.10 Consequência prática do OCP](#410-consequência-prática-do-ocp)
    - [4.11 Checklist mental para OCP](#411-checklist-mental-para-ocp)
  - [5. Liskov Substitution Principle (LSP)](#5-liskov-substitution-principle-lsp)
    - [5.1 Definição](#51-definição)
    - [5.2 O que significa "quebrar a substituição"](#52-o-que-significa-quebrar-a-substituição)
    - [5.3 Leitura guiada do exemplo errado](#53-leitura-guiada-do-exemplo-errado)
    - [5.4 O primeiro problema: o contrato do retângulo](#54-o-primeiro-problema-o-contrato-do-retângulo)
    - [5.5 O segundo problema: `new` oculta membro](#55-o-segundo-problema-new-oculta-membro)
    - [5.6 O que a aula "certa" realmente ensina](#56-o-que-a-aula-certa-realmente-ensina)
    - [5.7 A nuance importante: isso explica polimorfismo, mas não resolve totalmente o LSP](#57-a-nuance-importante-isso-explica-polimorfismo-mas-não-resolve-totalmente-o-lsp)
    - [5.8 Qual seria uma direção de modelagem melhor?](#58-qual-seria-uma-direção-de-modelagem-melhor)
    - [5.9 Checklist mental para LSP](#59-checklist-mental-para-lsp)
  - [6. Interface Segregation Principle (ISP)](#6-interface-segregation-principle-isp)
    - [6.1 Definição](#61-definição)
    - [6.2 O problema que ISP combate](#62-o-problema-que-isp-combate)
    - [6.3 Leitura guiada do exemplo errado](#63-leitura-guiada-do-exemplo-errado)
    - [6.4 Por que isso é ruim](#64-por-que-isso-é-ruim)
    - [6.5 O sinal de alerta: `NotImplementedException`](#65-o-sinal-de-alerta-notimplementedexception)
    - [6.6 Leitura guiada do exemplo correto](#66-leitura-guiada-do-exemplo-correto)
    - [6.7 O que significa "uma interface herdando outra"](#67-o-que-significa-uma-interface-herdando-outra)
    - [6.8 O papel de `PhotoCopier`](#68-o-papel-de-photocopier)
    - [6.9 O papel de `MultiFunctionPrinter`](#69-o-papel-de-multifunctionprinter)
    - [6.10 O que isso ensina além do ISP](#610-o-que-isso-ensina-além-do-isp)
    - [6.11 Checklist mental para ISP](#611-checklist-mental-para-isp)
  - [7. Dependency Inversion Principle (DIP)](#7-dependency-inversion-principle-dip)
    - [7.1 Definição](#71-definição)
    - [7.2 O que são alto nível e baixo nível?](#72-o-que-são-alto-nível-e-baixo-nível)
    - [7.3 Leitura guiada do exemplo errado](#73-leitura-guiada-do-exemplo-errado)
    - [7.4 Onde está a violação](#74-onde-está-a-violação)
    - [7.5 Ponto de C# que pode não ser familiar: LINQ `Where`](#75-ponto-de-c-que-pode-não-ser-familiar-linq-where)
    - [7.6 Leitura guiada do exemplo correto](#76-leitura-guiada-do-exemplo-correto)
    - [7.7 O que mudou estruturalmente](#77-o-que-mudou-estruturalmente)
    - [7.8 O que é "inversão" aqui?](#78-o-que-é-inversão-aqui)
    - [7.9 Relação com injeção de dependência](#79-relação-com-injeção-de-dependência)
    - [7.10 Checklist mental para DIP](#710-checklist-mental-para-dip)
- Parte 3 — Integração e Fechamento
  - [8. Como os princípios se conectam entre si](#8-como-os-princípios-se-conectam-entre-si)
    - [8.1 SRP e OCP](#81-srp-e-ocp)
    - [8.2 ISP e DIP](#82-isp-e-dip)
    - [8.3 LSP como guardião da abstração](#83-lsp-como-guardião-da-abstração)
    - [8.4 A visão madura](#84-a-visão-madura)
  - [9. Erros comuns ao estudar SOLID](#9-erros-comuns-ao-estudar-solid)
    - [9.1 Criar interface para tudo](#91-criar-interface-para-tudo)
    - [9.2 Confundir "muitos arquivos" com "bom design"](#92-confundir-muitos-arquivos-com-bom-design)
    - [9.3 Achar que herança é sempre reaproveitamento elegante](#93-achar-que-herança-é-sempre-reaproveitamento-elegante)
    - [9.4 Aplicar abstrações cedo demais](#94-aplicar-abstrações-cedo-demais)
    - [9.5 Decorar definição sem aprender a reconhecer sintomas](#95-decorar-definição-sem-aprender-a-reconhecer-sintomas)
